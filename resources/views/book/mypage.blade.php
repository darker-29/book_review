  ...
  <div class="mypage">
    ...
    <div class="mypage_down">
      ...
      <div class="mypage_down_review">
        ...
        <div class="mypage_down_review_menu-content hidden">
          <button type="submit" class="mypage_down_review_menu_edit">編集</button>
          <button type="submit" class="mypage_down_review_menu_delete">削除</button>
        </div>
    ...
    <div class="modal-edit">
        <div class="modal-edit-content">
            <div class="modal-top">
                ...
                <button type="button" class="modal-close-edit">×</button>
            </div>
    ...
    <div class="modal-delete">
        <div class="modal-delete-content">
          <button type="button" class="modal-close-delete">×</button>
